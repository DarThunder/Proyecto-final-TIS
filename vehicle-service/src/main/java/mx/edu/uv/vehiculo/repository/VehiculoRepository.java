...
public interface VehiculoRepository {
    ...
    /**
     * LO MISMO QUE LA DE ARRIBA PERO AHORA NOS REGRESA EL VEHICULO FULL EN VEZ
     * DEL NORMALITO
     *
     * @param idVehiculo
     */
     ...
     * Tampoco se pone el estatus ya que igual se establece que su valor default
     * es "1"
     *
     * Al parecer MyBatis puede checar los atributos de un objeto por si solo,
     * evitando poner vehiculo.get...() por cada valor ingresado en el query
     *
     * @param vehiculo
     */
     ...
     *
     * Este numero se retorna en el Service y se hace la validación para ver si
     * es mayor o menor que 4
     *
     * @param idUsuario
     */
    ...
    /**
     * LO MISMO QUE LA FUNCIÓN DE ARRIBA PERO CON LA CLAVE
     *
     * @param claveVehiculo
     * @return
     */
    @Select("SELECT COUNT(*) FROM vehiculofullinfo WHERE claveVehiculo = #{claveVehiculo}")
    Integer validacionClaveRepository(String claveVehiculo);
     ...
     *
     * Se usan @Param para evitar confusiones con los nombres de las variables
     * en el MyBatis
     *
     * @param idVehiculo
     * @param estatus
